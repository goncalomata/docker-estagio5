        ...
        if ($user) {
            ...
            if ($stmt->affected_rows > 0) {
                ...
                try {
                    ...
                    $mail->Body    = 'Olá ' . $user['name'] ."foi solicitada uma recuperação de password em seu nome. <br><br> Caso não tenha solicitado, ignore este e-mail, caso tenha solicitado, para prosseguir então com este processo clique no link abaixo <br><br><a href='" . $link . "'>" .$link . "</a>";
